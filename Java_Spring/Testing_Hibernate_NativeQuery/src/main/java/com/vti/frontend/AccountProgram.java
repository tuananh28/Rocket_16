...
public class AccountProgram {
	...
	public static void main(String[] args) throws ParseException {
		while (true) {
			...
			System.out.format(leftAlignFormat, "6. Update Account");
			System.out.format(leftAlignFormat, "7. Delete Account");
			System.out.format(leftAlignFormat, "8.	Phân trang");
	...
	private static void getUserByMonthOrder() throws ParseException {
		System.out.println("Thông tin User được tạo trong tháng hiện tại.");
