...
var CongNhan_1 = require("../Lab 1.3/CongNhan");
...
var address = "Hà Nội";
var rank = 7;
var congnhan1 = new CongNhan_1.CongNhan(name, age, gender, address, rank);
...
var congnhan1 = new CongNhan_1.CongNhan("cong_nhan1", 20, "FeMale", "HN", 10);
congnhan1.printInforCongNhan();
// Khai báo Worker2
var congnhan2 = new CongNhan_1.CongNhan("Worker2_Name2", 22, "Male", "HN", 9);
...
function printWorker_array() {
    ...
    congnhan2 = new CongNhan_1.CongNhan("Worker2_Name2_Change", 22, "Male_Change", "HN_Change", 9); // khai báo lại worker2 trong hàm này. thay đổi giá trị
    var congnhan3 = new CongNhan_1.CongNhan("Worker3", 22, "Male", "HN", 9); // Worker4 khai báo bên trong hàm, nên chỉ có phạm vi bên trong hàm này. ra ngoài sẽ không gọi được, giống khi báo với let
}
