...
function getListEmployees() {
    ...
    $.get("https://6127ea33c2e8920017bc0f20.mockapi.io/api/user", function(data, status) {
...
function addEmployee() {
    ...
    $.post("https://6127ea33c2e8920017bc0f20.mockapi.io/api/user", employee,
...
function updateEmployee() {
    ...
    $.ajax({
        url: 'https://6127ea33c2e8920017bc0f20.mockapi.io/api/user/' + id,
        type: 'PUT',
        data: employee,
