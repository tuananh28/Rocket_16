...
public class QLCB {
	...
	public void addCanBo() {
		...
		for (int i = 0; i < x; i++) {
			...
			switch (choose) {
			case 1:
				@SuppressWarnings("unused") NhanVien nhanVien = new NhanVien(null, choose, null, null, null);
				break;
			case 2:
				@SuppressWarnings("unused") CongNhan congNhan = new CongNhan();
				break;
			case 3:
				@SuppressWarnings("unused") KySu kySu = new KySu(null, choose, null, null, null);
				break;
			}
